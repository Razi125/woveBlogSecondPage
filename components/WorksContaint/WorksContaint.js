      ...
      <div className='flex flex-col mt-32 mb-32'>
          <div className='flex justify-between'>
             <div className='flex items-center -mt-16'>
                  <img  src='/images/pic22.svg' alt='' />
              </div>

              <div>
              <div>
              <h1 className='max-w-[843px] text-[#FFFFFF] text-2xl leading-[150%] font-semibold not-italic montserrat -tracking-[0.02em] pb-4'>The Meta-Layer</h1>
              </div>
              <div>
              <p className='max-w-[843px] text-[#D4D4D4] text-lg leading-[160%] font-normal not-italic avenir -tracking-[0.01em] pb-8'>Add Figma-like multiplayer functionality to any tool in your workflow, and link everything back to Wove with no additional clicks.</p>
              </div>
